...
@interface HHTest0ViewController () <UITableViewDelegate ,UITableViewDataSource, DoubleClickProtocol>

@property (nonatomic, strong) UITableView *tableView;

@end

@implementation HHTest0ViewController
